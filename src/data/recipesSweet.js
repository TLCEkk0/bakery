export const recipesSweet = [
  ...
  },
  {
    ...
    steps: [
      ...
      "ใส่ไข่ไก่ลงไป ตีต่อจนเข้ากันดี",
      "ใส่นมสดรสจืด และนมกลิ่นวนิลาบัตเตอร์ลงไป ตีต่อจนเข้ากันดี",
      "ใส่ส่วนผสมแป้งลงไป ใช้พายยางคนให้เข้ากันจนเป็นเนื้อเดียว",
      "ตักส่วนผสมใส่ถุงบีบที่เตรียมไว้ บีบลงบนถาดอบที่รองด้วยกระดาษไข",
      "นำเข้าอบที่อุณหภูมิ 170 องศาเซลเซียส เป็นเวลา 15-20 นาที หรือจนสุกเหลือง",
